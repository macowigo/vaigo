                ...
                <div class="row">
                    <div class="col s12">
                        <div class="receipt-main card-content">
                            <h6 class="blue-text centered-text">Add New Customer</h6>
                            {{-- errors --}}
                            ...
                            <form method="POST" action="{{route('addcustomer')}}">
                                ...
                                <div class=" row">
                                        <div class="input-field col s12">
                                            ...
                                            <span class="helper-text" data-error="please enter valid full name" data-success="right"></span>
                                        </div>
                                        <div class="input-field col s12">
