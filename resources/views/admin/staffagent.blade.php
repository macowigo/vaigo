                        ...
                        <div class="receipt-main card-content">
                            <h6 class="blue-text centered-text">
                               <i class="material-icons">support_agent</i>
                                Vaigo Agents {{number_format($agents)}}
                            </h6>
                            ...
                            {{-- check if vendor exist --}}
                                ...
                                <span class="red-text">Sorry there is no any agent list Found</span>
                                @else
                                ...
                                <table id="datatable" class="responsive-table">
                                    ...
                                    @foreach ($agentslist as $agents )
                                    <tr>
                                        <td>{{$agents->name}}</td>
                                        <td>{{$agents->phone}}</td>
                                        <td>{{$agents->email}}</td>
                                        <td>{{$agents->role}}</td>
                                        <td>{{$agents->centername.' '.$agents->centerlocation}}</td>
                                    </tr>
                                    @endforeach
                                </table>
                                @endif  
