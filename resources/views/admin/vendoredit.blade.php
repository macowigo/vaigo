                ...
                <div class="row">
                    <div class="col s12">
                        <div class="receipt-main card-content">
                            <h6 class="blue-text centered-text">Update Vendor Details</h6>
                            {{-- errors --}}
                            ...
                            @endforeach
                            <form method="POST" action="{{route('editvendor',$vendor->id)}}">
                                @csrf
                                <div class=" row">
                                    <div class="input-field col s12 m12 l6">
                                        <i class="material-icons prefix">account_circle</i>
                                        <input id="vendornames" name="vendornames" type="text" 
                                        value="{{$vendor->name}}" class="validate" required>
                                    ...
                                    <div class="input-field col s12 m12 l6">
                                        ...
                                        <input id="phone" name="phone" type="text" value="{{$vendor->phone}}"
                                       pattern="[0]{1}[1-9]{1}[0-9]{8}" class="validate" required>
                                        ...
                                        <div class="input-field col s12 m12 l6">
                                            ...
                                            <input id="vendorlocation" name="vendorlocation" type="text" 
                                            value="{{$vendor->vendor_location}}" class="validate" required >
                                    ...
                                    <input class="btn right blue" type="submit" value="UPDATE">
                                </div>
                            </form>
                        </div>
                    </div>
