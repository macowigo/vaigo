...
<head>
    ...
    <title>VAIGO-DomesticPendingOrders</title>
                        ...
                        <div class="receipt-main card-content">
                            <h6 class="blue-text centered-text">
                               <i class="material-icons">pending_actions</i>
                                Pending Domestic Orders: {{$domesticpending}}</h6>
                                @if ($domesticorders->isEmpty())
                                <span class="red-text">Sorry there is no Pending Domestic Order Found</span>
                                @else
