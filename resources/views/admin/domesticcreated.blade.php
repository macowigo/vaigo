...
<head>
    ...
    <title>VAIGO-DomesticCreatedOrders</title>
                        ...
                        <div class="receipt-main card-content">
                            <h6 class="blue-text centered-text">
                               <i class="material-icons">add_to_queue</i>
                                Created Domestic Orders: {{$domesticcreated}}</h6>
                                @if ($domesticorders->isEmpty())
                                <span class="red-text">Sorry there is no Created Domestic Order Found</span>
                                @else
