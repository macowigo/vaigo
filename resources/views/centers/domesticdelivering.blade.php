...
<head>
    ...
    <title>VAIGO-DomesticDeliveringOrders</title>
                        ...
                        <div class="receipt-main card-content">
                            <h6 class="blue-text centered-text">
                               <i class="material-icons">rotate_right</i>
                                Domestic Delivering Orders: {{$domesticdeliver}}</h6>
                                @if ($domesticorders->isEmpty())
                                <span class="red-text">Sorry there is no Domestic Delivering Order Found</span>
                                @else
