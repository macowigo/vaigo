...
<head>
    ...
    <title>VAIGO-DomesticCompleteOrders</title>
                        ...
                        <div class="receipt-main card-content">
                            <h6 class="blue-text centered-text">
                               <i class="material-icons">task_alt</i>
                                Domestic Complete Orders: {{$domesticcomp}}</h6>
                                @if ($domesticorders->isEmpty())
                                <span class="red-text">Sorry there is no Domestic Complete Order Found</span>
                                @else
